...
import type { EncryptedOutboxRecord } from "../lib/indexedDb";
import { recoverableDraftId, useAppStore, type DecryptedNote, type RetainedSectionDraft } from "../store/appStore";
...
vi.mock("../lib/indexedDb", async (importOriginal) => ({
  ...await importOriginal<typeof import("../lib/indexedDb")>(),
