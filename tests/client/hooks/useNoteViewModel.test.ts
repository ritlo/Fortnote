...
import type { BlockNoteFragmentSnapshot } from "@client/lib/blockNote";
...
vi.mock("@client/api", () => ({ listNoteSections: mocks.listNoteSections }));
vi.mock("@client/lib/indexedDb", () => ({
  openFortnoteIndexedDb: mocks.openFortnoteIndexedDb
}));
vi.mock("@client/lib/searchIndex", () => ({
...
import {
  ...
  useNoteViewModel
} from "@client/hooks/useNoteViewModel";
